...
from users.views  import feedback_create_view,add_answer_view,feedback_save,donesubmitting,export_users_xls,poco,feedback_create_view1,feedback_save1,index1
urlpatterns = [
